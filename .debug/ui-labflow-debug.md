...
### [2026-02-11] ������ҳ + ��ʼ������ڣ������Ӿ���ά��
- ����ָ����
  - Mood: ���ԡ����ܡ��ɹ۲⡣
  - Metaphor: ��ʵ��̨�ϵĹ�ѧɨ����������չʾϵͳ�������ٽ���������̡�
- �Ӿ��������ԣ�
  1. �ռ䣺ԭҳ��򿪼��������壬��Ϣ�ܶȸߣ����� Landing �������ֲ�չʾ����������ڶ�����
  2. ����������ɨ��߹⡢������������Ƭ������������ǿ�����Ǳ��С�
  3. �ʸУ���㽥�� + ��͸����Ƭ + ����Ӱ�����ⴿƽ���档
  4. ΢��������ڰ�ť hover ����������ҳ����ʱ�ϸ����ɡ�
- ʵʩ��¼��
  - `frontend/src/App.tsx`������ `hasEntered` ���״̬�����붯����ҳ DOM���������ʼ����������Ⱦԭ�� 1~7 ���̡�
  - `frontend/src/styles/tokens.css`������ landing ��� token ����ʽ������㡢ɨ�趯������Ƭ��������ڰ�ť��Ч���ƶ������䣩��
- �û�˵������£�
  - `docs/LabFlowǰ���û�����˵��.md` ������������ҳ��ڣ���ʼ���������½ڣ�Ŀ�ġ�������Ԥ�ڡ��������⡢�ع�����
- �����ĵ�������飺
  - �Ѽ�� `docs/�����ĵ�.md`�����ν�ǰ���Ӿ�����ڽ����仯�����漰���������뻷������������Ķ���
- Checkfix��
  - `npm run lint`��frontend��ͨ����
  - `npm run build`��frontend��ͨ����

### [2026-02-11] ��ҳע��/��¼ + �û�˵������ڣ�����������֤��
- Ŀ�꣺�ڶ�����ҳ�����ֱ��ʹ�õ��˺���ڣ���¼�����������̣������û�˵���鰴ť������ҳ��
- ���ʵ�֣�API-First����
  ...
  - `backend/app/main.py` ·�ɹ��أ�ҵ�� API ͳһ�� `require_auth`������ `LABFLOW_AUTH_REQUIRED` ���ƣ���
  - `backend/app/core/config.py` ������֤���ã�`LABFLOW_AUTH_REQUIRED`��`LABFLOW_AUTH_DB_PATH`��`LABFLOW_AUTH_SESSION_TTL_HOURS`��
- ǰ��ʵ�֣���ҳ����뽻������
  - `frontend/src/App.tsx`����ҳ����ע��/��¼��������¼̬��ʾ���˳���¼��δ��¼���á���ʼ��������
  - ��ҳ���û�˵���顱��ť��Ϊ��������ĵ��ӿڣ�`/api/auth/user-guide`��
  - `frontend/src/services/api.ts`������ auth API ��װ�� token ���ش�ȡ�������Զ�Я�� Bearer Token��
  - `frontend/src/styles/tokens.css`������ auth panel��tabs����ť��ʽ��
- �ĵ�ͬ����
  - ���� `docs/api/auth.md`��
  - ���� `docs/LabFlowǰ���û�����˵��.md`��������ҳע��/��¼��������򣩡�
  - ���� `docs/�����ĵ�.md`��������֤��ػ�����������
  - ���� `README.md`��������¼��֤˵����ڣ���
- �û��������Լ����ۣ�
  - ���ۣ����������������֡�˵�����Ѹ��ǡ��ȵ�¼�ٿ�ʼ��������·�����˺Ź��򡢳���������
  - �Խ��飨��������������һ�š�ע��->��¼->��ʼ���������̽�ͼ����һ�������״���֪�ɱ���
- Checkfix��
  - `ruff check backend/app backend/tests` ͨ����
  - `ruff format --check backend/app backend/tests` ͨ����
  - `npm run lint`��frontend��ͨ����
  - `npm run build`��frontend��ͨ����
  - `python -m pytest -q backend/tests/test_auth_api.py` δִ�У���ǰ����ȱ�� pytest����
